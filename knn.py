...
training_set_list = readMnistData("train-images.idx3-ubyte","train-labels.idx1-ubyte",training_limit)
print("Training set read.")
#Reat test set to list
test_set_list = readMnistData("t10k-images.idx3-ubyte","t10k-labels.idx1-ubyte",test_limit)
print("Test set read.")
